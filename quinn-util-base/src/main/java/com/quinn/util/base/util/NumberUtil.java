...
public final class NumberUtil {
    ...
    public static Double parseDouble(Object o) {
        ...
        if (!isDouble(o)) {
            throw new DataStyleNotMatchException()
                    .getMessageProp()
                    .addParamI8n(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[0], Double.class.getName())
                    .addParam(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[1], o)
                    .exception();
        }
    ...
    public static BigDecimal paresBigDecimal(Object o) {
        ...
        if (!isBigDecimal(o)) {
            throw new DataStyleNotMatchException()
                    .getMessageProp()
                    .addParamI8n(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[0], BigDecimal.class.getName())
                    .addParam(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[1], o)
                    .exception();
        }
    ...
    public static Long parseLong(Object o) {
        ...
        if (!isLong(o)) {
            throw new DataStyleNotMatchException()
                    .getMessageProp()
                    .addParamI8n(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[0], Long.class.getName())
                    .addParam(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[1], o)
                    .exception();
        }
    ...
    public static Integer parseInteger(Object o) {
        ...
        if (!isInteger(o)) {
            throw new DataStyleNotMatchException()
                    .getMessageProp()
                    .addParamI8n(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[0], Integer.class.getName())
                    .addParam(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[1], o)
                    .exception();
        }
    ...
    public static Short parseShort(Object o) {
        ...
        if (!isShort(o)) {
            throw new DataStyleNotMatchException()
                    .getMessageProp()
                    .addParamI8n(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[0], Short.class.getName())
                    .addParam(ExceptionEnums.DATA_STYLE_NOT_MATCHED.paramNames[1], o)
                    .exception();
        }
