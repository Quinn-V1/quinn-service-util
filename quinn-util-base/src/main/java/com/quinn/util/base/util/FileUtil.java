    ...
    public static void copyNio(String source, String dest) {
        ...
        try {
            ...
            throw new FileOperationException()
                    .addParam(ExceptionEnums.FILE_STREAM_OPERATION_FAIL.paramNames[0], source + "->" + dest)
                    .addParam(ExceptionEnums.FILE_STREAM_OPERATION_FAIL.paramNames[1], FileOperationTypeEnum.COPY.name())
                    .exception();
        } finally {
